...
test('many matches highlighted search', (t) => {
  const result = search('Hello my name is bob and I live down a street with many people', ['e'], 10);
  t.is(result.length, 1);
  t.is(result[0].highlights.length, 6);
});
